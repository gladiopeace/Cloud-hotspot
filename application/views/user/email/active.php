    ...
    <div class="wwrap wrap-boxes">
        ...
        <div class="pwd-reset-result">
            ...
            <div class="pwd-rstsuc-inner">
                <p class="pwd-rstsuc-txt">恭喜您的邮箱验证已通过，开始愉快的体验吧</p>
                <p>
                    你的邮箱 <?php echo $user['email'];?> 验证成功 <br>
                    <span id="pwd-rstsuc-timer" class="pwd-rstsuctm-wrap">5</span>秒后自动跳转到云热点首页
                </p>
            </div>
