    ...
    <div class="col-md-12">
        ...
        <div class="col-lg-12">
          ...
          <td>{{v['addtime']|date('Y-m-d H:i:s')}}
            ...
            <td>
            <a href="/hotspot/screenupdate?accesskey={{accesskey}}&token={{v['id']}}" class="btn btn-success">修改</a>
            ...
            <div class="col-sm-6">
                ...
                <a href="/hotspot/screen_add?accesskey={{accesskey}}" class="btn btn-primary ">增  加</a>
            </div>
            <div class="col-sm-6">
